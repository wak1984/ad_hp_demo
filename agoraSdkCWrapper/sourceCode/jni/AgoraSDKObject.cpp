...
int CAgoraSDKObject::startScreenCapture(HWND windowId, int captureFreq, int rc_left, int rc_top, int rc_width, int rc_height, int bitrate, const char* GameName)
{
    Rect rc(rc_left, rc_top, rc_width, rc_height);
    return irtcEngine->startScreenCapture(windowId, captureFreq, &rc, bitrate, GameName);
}
